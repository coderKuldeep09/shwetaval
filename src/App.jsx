...
const data = [
  { q: "The First Meet 🌸", line: "Kabhi kabhi sochta hoon ki meri life itni khoobsurat kab ho gayi… phir yaad aata hai tum aayi thi 💗 Tum sirf meri pasand nahi ho, tum meri aadat ban chuki ho. Din kaisa bhi ho, agar tumse baat ho jaye na to sab theek lagne lagta hai ✨ Tumhari hasi mere liye therapy hai, aur tumhari awaaz mera sukoon 🫶

Mujhe nahi pata pyaar ka perfect definition kya hota hai, par jab main tumhare baare mein soch ke bina wajah smile karne lagta hoon, shayad wahi pyaar hai ❤️ Main future plan nahi karta zyada, par ek cheez pakki hai — jahan meri zindagi hogi, wahan tum zaroor hogi 💍

Dil karta hai tumhe har tension se door rakhu, tumhari har choti khushi ka reason banu 🌷 Tum mere liye wo insaan ho jisse baat kiye bina din complete nahi hota 🥺 Aur sach kahu, agar tum saath ho na, to life itni mushkil bhi nahi lagti 💞

Bas ek hi wish hai — aise hi saath rahe, haste rahe, ladte rahe, manaate rahe… par kabhi ek dusre ka haath na chhode 🤍 Tum meri lucky charm ho, meri peace ho, aur meri sabse pyari feeling ho 💘...", sticker: "✨" },
